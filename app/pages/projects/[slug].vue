<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div v-else-if="error" class="bg-red-50 border border-red-200 rounded-lg p-6">
      ...
      <NuxtLink to="/projects" class="mt-4 inline-block text-indigo-600 hover:text-indigo-800">
        ← Retour aux projets
      </NuxtLink>
    </div>
...
useHead({
  ...
  meta: [
    { name: 'description', content: project.value?.description || 'Détails du projet' }
  ]
})
</script>
