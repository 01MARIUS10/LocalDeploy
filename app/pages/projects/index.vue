      ...
      >
        <div class="p-6">
          ...
          <div class="flex flex-wrap gap-1 mb-4">
            ...
            <span v-if="project.technologies.length > 3" class="px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs">
        ...
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 h-1 group-hover:h-2 transition-all duration-300"></div>
      </NuxtLink>
    </div>
