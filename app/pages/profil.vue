    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex flex-col sm:flex-row items-start sm:items-end -mt-16 mb-6">
            ...
            <div class="relative">
              <div class="w-32 h-32 rounded-full bg-white p-2 shadow-xl">
                <div class="w-full h-full rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
                  {{ userInitials }}
                </div>
              </div>
              <button class="absolute bottom-2 right-2 w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-6 flex-1">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <button class="mt-4 sm:mt-0 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-md">
                  Modifier le profil
                </button>
              </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-3xl font-bold text-blue-900 mt-1">{{ stats.totalProjects }}</p>
                </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-3xl font-bold text-green-900 mt-1">{{ stats.totalDeployments }}</p>
                </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-3xl font-bold text-purple-900 mt-1">{{ stats.activeProjects }}</p>
                </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8">
        ...
        <div v-else-if="filteredProjects.length === 0" class="text-center py-12">
          ...
          <p class="text-gray-500 text-sm">Commencez par créer votre premier projet !</p>
        </div>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <!-- Stats -->
            <div class="flex items-center justify-between text-sm text-gray-500 pt-4 border-t border-gray-300">
...
const { data: projectsData, pending, error } = await useFetch('/api/projects', {
...
const filteredProjects = computed(() => {
  ...
  return projectsData.value.projects.filter(p => p.status === activeFilter.value)
})

// Statistiques
const stats = computed(() => ({
  totalProjects: projectsData.value?.projects.length || 0,
  totalDeployments: projectsData.value?.projects.reduce((acc, p) => acc + p._count.deployments, 0) || 0,
  activeProjects: projectsData.value?.projects.filter(p => p.status === 'active').length || 0
}))
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Gérez votre profil et vos projets sur LocalDeploy' }
  ]
})
</script>
